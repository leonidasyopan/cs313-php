<section id="contact-information-footer">
    <div class="content-width "> <!-- This DIV has only style purposes -->
        <div>
            <h2>CS 313 - Web Engineering II</h2>
            <p>This piece belongs to my projects in CSS 313 at BYU Idaho Online</p>
        </div>

        <div>

            <p>Some of my personal information. You are welcomed to get in touch with me.</p>
